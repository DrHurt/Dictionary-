...
@property(nonatomic, readonly, strong) NSString *primaryLanguage;
...
{    
    ...
    NSArray *completions = [self.textChecker completionsForPartialWordRange:range inString:word language:lang];
